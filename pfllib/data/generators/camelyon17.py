...
def generate_dataset(dir_path):
    ...
    # Get data
    dataset = get_dataset(dataset="camelyon17", root_dir=dir_path + "rawdata", download=True)
    ...
    save_file(
        config_path, train_path, test_path, train_data, test_data, num_clients, num_classes, statistic, None, None, None
    )
