...
def generate_dataset(dir_path, num_clients, niid, balance, partition):
    ...
    dataset = ImageDataset(dataframe=train_df, image_folder=train_dir, transform=transform)
    ...
    dataset = ImageDataset(dataframe=val_df, image_folder=val_dir, transform=transform)
    dataloader = DataLoader(
        dataset,
        batch_size=len(dataset),
        shuffle=False,
    ...
    dataset = ImageDataset(dataframe=test_df, image_folder=test_dir, transform=transform)
    dataloader = DataLoader(
        dataset,
        batch_size=len(dataset),
        shuffle=False,
