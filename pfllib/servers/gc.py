...
class FedGC(Server):
    def __init__(self, args, times):
        ...
        self.opt_client_heads = [
            torch.optim.SGD(h.parameters(), lr=self.server_learning_rate) for h in self.client_heads
        ]
        ...
        logger.info("client_inlude_cla", self.client_inlude_cla)
        logger.info("client_exlude_cla", self.client_exlude_cla)
    ...
    def reg_train(self):
        ...
        logger.info("Server reg:", Reg.item())
