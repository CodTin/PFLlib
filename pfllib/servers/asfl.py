...
from pfllib.clients.asfl import ClientAS
...
class FedAS(Server):
    ...
    def train(self):
        ...
        logger.info(f"Generalization Acc: {gen_acc}")
        logger.info("+++++++++++++++++++++++++++++++++++++++++")
    ...
    def print_fim_histories(self):
        ...
        for client in self.alled_clients:
            ...
            logger.info(f"Client{client.id} : {formatted_history}")
        ...
        logger.info(f"Avg Sum_T_FIM : {formatted_avg}")
